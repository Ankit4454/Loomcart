...
import { toggle, wishlistSelector } from '../reducers/wishlistReducers';
...
function Like(props) {
    ...
    useEffect(() => {
        setPresent(wishlist.some(item => item._id === _id));
    }, [_id, wishlist]);

    return (
        <div onClick={handleToggleLike} className={styles.heartContainer} title="Like">
            {present ? (
            ...
            <div className={styles.svgContainer}>
                ...
                <svg className={styles.svgCelebrate} width="40" height="40" xmlns="http://www.w3.org/2000/svg">
