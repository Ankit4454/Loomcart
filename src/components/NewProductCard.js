...
function NewProductCard(props) {
    ...
    return (
        <div className="rounded-2xl bg-lightTeal m-4 border-2 border-teal-700">
            <div className="md:flex">
                <img src={picture} alt="Product" className="rounded-2xl md:w-1/3" />
                <div className="p-6 flex flex-col justify-between">
                    <div>
                        <h2 className="font-bold text-xl md:text-3xl mb-2 text-gray-800">{name}</h2>
                        ...
                        <p className="mt-4 flex items-center text-xl md:text-3xl text-gray-800">
